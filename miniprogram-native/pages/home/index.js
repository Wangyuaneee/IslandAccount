...
Page({
  ...
  setSlow(){this.setData({speed:'slow',delay:1000});wx.showToast({title:'速度：慢速',icon:'none'})},
  setMedium(){this.setData({speed:'medium',delay:500});wx.showToast({title:'速度：中速',icon:'none'})},
  setFast(){this.setData({speed:'fast',delay:100});wx.showToast({title:'速度：快速',icon:'none'})},
